<template>
  <div>
    <div v-if="!selectedType">
      <h2 class="text-lg font-semibold mb-6">请选择广告类型</h2>
      
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- 软广选项 -->
        <div 
          @click="selectType('soft')" 
          class="bg-white rounded-lg shadow-md p-6 border-2 border-transparent hover:border-blue-500 cursor-pointer transition-all"
        >
          <div class="flex items-center justify-center h-16 w-16 rounded-full bg-blue-100 text-blue-600 mb-4 mx-auto">
            <MessageSquare class="h-8 w-8" />
          </div>
          <h3 class="text-xl font-semibold text-center mb-2">软广告</h3>
          <p class="text-gray-600 text-center">
            内容营销、软文推广、KOL合作等原生广告形式
          </p>
          <div class="mt-4 text-center">
            <span class="inline-block px-4 py-2 bg-blue-50 text-blue-600 rounded-full text-sm">
              更自然的用户体验
            </span>
          </div>
        </div>
        ...
        <div 
          ...
          class="bg-white rounded-lg shadow-md p-6 border-2 border-transparent hover:border-purple-500 cursor-pointer transition-all"
        >
          <div class="flex items-center justify-center h-16 w-16 rounded-full bg-purple-100 text-purple-600 mb-4 mx-auto">
            <Image class="h-8 w-8" />
          </div>
          <h3 class="text-xl font-semibold text-center mb-2">硬广告</h3>
          <p class="text-gray-600 text-center">
            Banner广告、弹窗广告、插页广告等传统展示广告
          </p>
          <div class="mt-4 text-center">
            <span class="inline-block px-4 py-2 bg-purple-50 text-purple-600 rounded-full text-sm">
              更高的曝光率
            </span>
          </div>
        </div>
